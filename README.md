...
* By Julien Barbier
* Weight: 10
* Project to be done in teams of 2 people (your team: RODGY Kamota, Loay Al_Said)
* Project will start Jul 12, 2023, 6:00 AM, must end by Jul 27, 2023, 6:00 AM
* Checker will be released on Jul 26, 2023, 1:12 AM
...
First, remember the framework. If you do not know it by heart already, it is probably a good idea to reread it again: https://intranet.alxswe.com/concepts/559
...
* NEVER copy any code, never look at the solution (and never give any solution to your friends, you are not helping them by doing so)
* ALWAYS write code alone from scratch after getting help to check that you have actually understood. If you can not do it, you have not understood enough, and need to study more. Do not rewrite code from memory, but from understanding.
I saw some of you sharing resources with each other already. Tutorials on how to do the shell step by step with all the code associated with these, or even videos and documents with the solution without  any explanation. This is not the right way to learn. Please do not be tempted by these links. They will only push you to take shortcuts and/or cheat. And trust me, you will be caught. Kimba is not a joke and he is here to remind you why you are here.
...
* I do nothing and cross my fingers for my partner to do everything so I can have a good score
